    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="d-flex flex-wrap gap-3 py-3">
          <span class="px-2"><a href="{{ route('politicas') }}" style="color:#fff;" aria-label="Ver Políticas de Privacidad">Políticas de privacidad</a></span>
          <span class="px-2"><a href="{{ route('terminos') }}" style="color:#fff;" aria-label="Ver Términos y Condiciones">Términos y Condiciones</a></span>
          <span class="px-2"><a href="{{ route('declaracion') }}" style="color:#fff;" aria-label="Ver Declaración de Accesibilidad">Declaración de Accesibilidad</a></span>
          <span class="px-2"><a href="{{ route('acreditacion') }}" style="color:#fff;" aria-label="Ver Acreditaciones">Acreditaciones</a></span>
          <span class="px-2"><a href="{{ route('credito') }}" style="color:#fff;" aria-label="Ver Créditos">Crédito</a></span>
        </div>
      </div>
    </div>
    <div class="container">
